...
excludes = %w[Rakefile README.rdoc LICENSE bin autojump man git-tools sshuttle gitflow todo.txt-cli libraries xssh git-archive-all git-blameall cheat pastebinit]
