...
excludes = %w[Rakefile README.md LICENSE ack bash bin autojump man git-tools sshuttle gitflow todo.txt-cli libraries xssh git-archive-all git-blameall git-store cheat pastebinit]
